...
const Sidebar = () => {
  ...
  // Función para manejar clic con sonido
  const toggleSidebar = () => {
    const audio = new Audio(open ? downsound : upsound);
    setOpen(!open);
    audio.play();
  ...
  return (
    <div className="flex">
      ...
      >
        <ArrowRight
          className={`bg-white text-black text-3xl rounded-full absolute -right-3 top-8 border-2 cursor-pointer transition-transform duration-200 ${
            open && "rotate-180"
          } z-50`}
