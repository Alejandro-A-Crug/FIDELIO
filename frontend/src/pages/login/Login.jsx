    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        <div className='w-full p-6 rounded-lg shadow-md bg-white/10 backdrop-blur-md border border-white/20'>
            ...
            <form onSubmit={handleSubmit}>
               ...
               <Link to={"/signup"} className='text-sm hover:underline text-white hover:text-blue-300 mt-2 inline-block'>
                Don't have an account?
               </Link>

               <div className='flex justify-center'> 
               <button class="btn btn-soft btn-info" disabled={loading}>{loading ? <span className='loading loading-spinner'></span> : "Log In"}</button>
               </div>
            </form>
        </div>
